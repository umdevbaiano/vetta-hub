          ...
          <div className="faq-wrap">
            ...
            <div className="r" data-d="3">
              <div className="faq-item">
                <button className="faq-btn" onClick={(e) => typeof window !== 'undefined' && (window as any).faq(e.currentTarget)}>A Vetta atende empresas de qualquer segmento? <span className="faq-ico">+</span></button>
              ...
              <div className="faq-item">
                <button className="faq-btn" onClick={(e) => typeof window !== 'undefined' && (window as any).faq(e.currentTarget)}>Quanto tempo leva para desenvolver um software sob medida? <span className="faq-ico">+</span></button>
              ...
              <div className="faq-item">
                <button className="faq-btn" onClick={(e) => typeof window !== 'undefined' && (window as any).faq(e.currentTarget)}>Como funciona o modelo White Label? <span className="faq-ico">+</span></button>
              ...
              <div className="faq-item">
                <button className="faq-btn" onClick={(e) => typeof window !== 'undefined' && (window as any).faq(e.currentTarget)}>Posso contratar apenas consultoria? <span className="faq-ico">+</span></button>
              ...
              <div className="faq-item">
                <button className="faq-btn" onClick={(e) => typeof window !== 'undefined' && (window as any).faq(e.currentTarget)}>O suporte continua após a entrega? <span className="faq-ico">+</span></button>
